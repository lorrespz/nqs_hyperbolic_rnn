...
#This value can be changed before each run of the script.
cn = 8.0
print(f'Training with gradient clipping by global norm of {cn} (both Euclidean and hyperbolic)')
...
def run_J1J2(wf, numsteps, systemsize, var_tol, J1_  = 1.0, J2_ = 0.0, Marshall_sign = False, 
    ...
    learning_rate_withexpdecay  = keras.optimizers.schedules.ExponentialDecay(initial_learning_rate=learningrate,
                                                        decay_steps=100,
                                                        decay_rate=0.9)
    optimizer=tf.keras.optimizers.Adam(learning_rate=learning_rate_withexpdecay, clipnorm = cn) 
...
def run_J1J2_hypvars(wf, numsteps, systemsize, var_tol, J1_  = 1.0, J2_ = 0.0, Marshall_sign = True, 
    ...
    learning_rate_withexpdecay  = keras.optimizers.schedules.ExponentialDecay(initial_learning_rate=lr1,
                                                        decay_steps=100,
                                                        decay_rate=0.9)
    opt_eucl=tf.keras.optimizers.Adam(learning_rate=learning_rate_withexpdecay, clipnorm = cn) 
